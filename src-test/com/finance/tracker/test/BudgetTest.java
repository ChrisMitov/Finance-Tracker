...
public class BudgetTest {
	...
	private static final String NEW_USER_EMAIL = "Kenobi2@gmail.com";
	...
	private static final String USER_EMAIL = "aaa23@gmail.com";
...
<<<<<<< HEAD
	public void testBudgetAccountRelation() throws FinanceTrackerException{
		Budget b = new Budget("Ne znam", 120, new Date(), RepeatType.NO_REPEAT, new UserDAO().getUser(1101));
		IAccount account = new Account("Pak ne znam", 30,new UserDAO().getUser(1101));
		accountDao.createAccount(account);
		b.addAccount((Account) account);
		dao.addBudget(b);
=======
	public void testBudgetAccountRelation() throws FinanceTrackerException {
		...
		Budget b = new Budget("Testov2", 120, new Date(), new Date(),new UserDAO().getUser(3051));
		b.addAccount(a);
		b.addAccount(c);
...
>>>>>>> 2be7bba6f0b063812db7d93911f0e8b8a35ac950
	}
