		...
		<div class="content-main">
			...
			<div class="banner">
				<h2>
					<a href="./">Home</a> <i class="fa fa-angle-right"></i> <a
						href="./incomes">Incomes</a> <i class="fa fa-angle-right"></i> <span>Edit
						income</span>
				</h2>
			</div>
			<!--//banner-->
			...
			<div class="grid-form">
				<div class="grid-form1">
					<h3 id="forms-example" class="">Edit income</h3>
					<form name="expenses" action="./editIncome" method="post"
						class="demo">
						<table>
							<tr>
								<th><label style="font-size: 28px" for="sum">Sum: </label></th>
								<td><input id="sum" name="sum" type="number"
									class="form-control" placeholder="Sum" value="${income.sum}"
							...
							<tr>
								...
								<td><input id="description" name="description" type="text"
									...
									value="${income.description}" style="width: 400px;"></td>
							</tr>
							<tr>
